...
export default {
  ...
  methods: {
    ...
    async getClientDetails() {
      ...
      this.TripdetailOpt = this.clientTemplete.addressTemplateData.TripdetailData
      console.log(this.clientTemplete)
    },
    async changeTripdetail(value) {
      console.log(value)
      const result = await TripdetailTemplete(value)
          ...
          address: [
            {
              ...
              Tripdetail: this.form.Tripdetail,
      ...
      >
        ...
        <div class="mt-3">
          ...
          >
            ...
            <b-button size="sm" class="mr-2" variant="facebook" @click="editTripdetail(data)">
            ...
            <template slot="row-details" slot-scope="row">
              <b-card class="role-details">
                <div>
                  <multiselect
                    :id="row.item._id"
                    :value="TripdetailMap[row.item._id]"
                    :options="allTripdetail"
                    label="Tripdetail"
                    track-by="Tripdetail"
                    :multiple="true"
                    @select="
                      (selectedOption, id) =>
                        addTripdetailToRole(selectedOption, id, row)
                    "
                  ></multiselect>
                </div>
              </b-card>
