      ...
      items: [
        {
         ...
         {
          text: 'Payroll Driver',
          href: '#/Payroll/Ratecard/PayrollDriver',
        },
        {
          text: 'Edit PayrollDriver',
          active: true,
        },
      ],
      days: [
 ...
 this.typemaster.map((e) => {
     ...
     this.typemaster.map(e=>{
       this.days.push(e.tripType)
         if(this.$route.params.tripType === e.tripType){
      this.tripid = e.id
            }
     })
      } catch (error) {}
    ...
    async create() {
      try {
        ...
        const result = await editpayrolldriver(payload)
        ...
        if (result) {
          this.$swal({
            group: 'alert',
            type: 'success',
            text: `Your Edited Payroll Driver  Successfully`,
            duration: 5000,
          })
...
<template>
  <Layout>
    ...
    <div class="animated fadeIn">
      <b-card header="Edit Payroll Driver" class="mt-10 ml-10 mr-10 mx-auto">
        <div class="mt-3">
