...
import {
 ...
 getLguById,stagingarea,getgarbagebystate, lgus
} from '../../../../services/auth'
...
export default {
  ...
  methods: {
    async getLgu() {
      ...
      data.map(e => {
        if(e.lguName == this.$route.params.lguName) {
          this.lguId = e.id
        }
      })
    },
        ...
        <div class="mt-3">
              <form @submit.prevent="update">
                  ...
                  <b-col>
                    ...
                    >
                     <b-form-select
                      ...
                      :options="drivers"
                      @change="getid" 
                        oninvalid="this.setCustomValidity('Driver is required ')"
                  oninput="setCustomValidity('')"
                  required
                    >
                    </b-form-select>
                ...
                <button
                  ...
                  type="submit"
                  class="btn btn-info mt-3 float-right mr-5"
                  >Save</button>
              </form>
        </div>
      </b-card>
