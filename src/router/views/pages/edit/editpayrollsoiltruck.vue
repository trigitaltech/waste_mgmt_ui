...
export default {
  ...
  data() {
    return {
      ...
      lgus: [],
      lgusdata: "",
      lguname: this.$route.params.dumpingId,
  ...
  methods: {
      ...
      this.lgusnames = result.data.response.dumpingLocation
        ...
        this.lgusnames.map((e) => {
          this.lgus.push(e.dumpingAreaName)
           ...
           if(this.$route.params.dumpingId === e.dumpingAreaName){
           this.lgusdata = e.id
            }
        })
        // data.map( e => {
    ...
    "helperRate": this.helperrate,
        ...
        const result = await editpayrollsoiltruck(payload)
        ...
        if (result) {
          this.$swal({
            group: 'alert',
            type: 'success',
            text: `Your Edited Payroll SoilTruck  Successfully`,
            duration: 5000,
          })
...
<template>
  <Layout>
    ...
    <div class="animated fadeIn">
      <b-card header="Edit PayrollSoilTruck" class="mt-10 ml-10 mr-10 mx-auto">
        <div class="mt-3">
