    ...
    "equipmentDailyRate": this.equipmentrate,
        ...
        if (result) {
          this.$swal({
            group: 'alert',
            type: 'success',
            text: `Your Edited Payroll Equipment  Successfully`,
            duration: 5000,
          })
...
<template>
  <Layout>
    ...
    <div class="animated fadeIn">
      <b-card header="EditPayrollEquipment" class="mt-10 ml-10 mr-10 mx-auto">
        <div class="mt-3">
