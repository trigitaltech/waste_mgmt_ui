 ...
 this.typemaster.map((e) => {
    ...
    async create() {
      try {
        ...
        const result = await Createpayrollhelper(payload)
        ...
        if (result) {
          this.$swal({
            group: 'alert',
            type: 'success',
            text: `Your Created Payroll Helper  Successfully`,
            duration: 5000,
          })
             this.$router.push({path:'/Payroll/Ratecard/PayrollHelper'})
        }
      } catch (e) {
...
<template>
  <Layout>
    ...
    <div class="animated fadeIn">
      <b-card header="CreatePayrollHelper" class="mt-10 ml-10 mr-10 mx-auto">
        <div class="mt-3">
