...
export default {
  page: {
    title: 'Create Payroll Equipment',
  ...
  methods: {
    ...
    "equipmentDailyRate": this.equipmentrate,
        ...
        const result = await Createpayrollequipment(payload)
...
<template>
  <Layout>
    ...
    <div class="animated fadeIn">
      <b-card header="CreatePayrollEquipment" class="mt-10 ml-10 mr-10 mx-auto">
        <div class="mt-3">
