 ...
 this.typemaster.map((e) => {
    ...
    async create() {
      try {
        ...
        const result = await Createpayrollpalero(payload)
        ...
        if (result) {
          this.$swal({
            group: 'alert',
            type: 'success',
            text: `Your Created Payroll Palero  Successfully`,
            duration: 5000,
          })
...
<template>
  <Layout>
    ...
    <div class="animated fadeIn">
      <b-card header="CreatePayrollPalero" class="mt-10 ml-10 mr-10 mx-auto">
        <div class="mt-3">
