...
const salesDonutChart = {
  chartOptions: {
    ...
    legend: {
     ...
     labels: ['Topup -Voucher Payment', 'Topup - Online Payment', 'TVoD - Voucher Payment', 'TVoD - Online Payment'],
...
const salesDonutChartstb = {
  chartOptions: {
    ...
    labels: ['Allocated', 'Exported', 'Reedemed'],
    responsive: [
      {
        breakpoint: 480,
        options: {
...
export { revenueAreaChart, targetsBarChart, salesDonutChart, ordersData ,salesDonutChartstb }
