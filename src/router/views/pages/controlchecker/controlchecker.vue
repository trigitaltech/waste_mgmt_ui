...
//   },
  mounted() {
    ...
    this.controlCheckerId = result.lguemployee.id
          ...
          <img src="@assets/images/PIN.jpg">
              ...
              <div class="col-sm-12 col-md-6">
                ...
                <div class="table-responsive mb-0">
                  ...
                  >
                    <template v-slot:cell(action)="data">
                      <router-link v-if="data.item.status == 'STARTED' || data.item.status == 'COMPLETED'" :to="{ name: 'EditoutgoingtripByControlChecker', params: data.item }">
                        <span class="mr-2" >
